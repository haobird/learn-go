...
type GreeterSayHelloResult struct {
  ...
  E *BizException `thrift:"e,1" db:"e" json:"e,omitempty"`
}
...
var GreeterSayHelloResult_E_DEFAULT *BizException
func (p *GreeterSayHelloResult) GetE() *BizException {
  if !p.IsSetE() {
    return GreeterSayHelloResult_E_DEFAULT
  }
return p.E
}
...
func (p *GreeterSayHelloResult) IsSetE() bool {
  return p.E != nil
}
...
func (p *GreeterSayHelloResult)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  p.E = &BizException{}
...
func (p *GreeterSayHelloResult) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetE() {
...
var GreeterGetUserResult_E_DEFAULT *BizException
func (p *GreeterGetUserResult) GetE() *BizException {
  if !p.IsSetE() {
    return GreeterGetUserResult_E_DEFAULT
  }
return p.E
}
...
func (p *GreeterGetUserResult) IsSetE() bool {
  return p.E != nil
}
...
func (p *GreeterGetUserResult)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
  p.E = &BizException{}
  if err := p.E.Read(ctx, iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.E), err)
  }
...
func (p *GreeterGetUserResult) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
  if p.IsSetE() {
    if err := oprot.WriteFieldBegin(ctx, "e", thrift.STRUCT, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:e: ", p), err) }
    if err := p.E.Write(ctx, oprot); err != nil {
