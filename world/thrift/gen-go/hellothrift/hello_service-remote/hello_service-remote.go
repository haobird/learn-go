...
var _ = hellothrift.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  HelloResp SayHello(HelloReq req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := hellothrift.NewHelloServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "SayHello":
    ...
    argvalue0 := hellothrift.NewHelloReq()
